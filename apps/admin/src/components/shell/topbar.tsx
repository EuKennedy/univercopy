...
export function Topbar({ title, eyebrow, description, actions, className }: TopbarProps) {
  return (
    <header
      className={cn(
        'sticky top-0 z-30 px-8 py-6 flex flex-wrap items-end gap-4 justify-between',
    ...
    >
      <div className="min-w-0">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-[var(--uc-text)] leading-[1.05]">
          {title}
        </h1>
        {description && (
