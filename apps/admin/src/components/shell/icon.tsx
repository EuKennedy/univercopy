// Icon set centralizado — SVG inline (sem emoji). Mantém viewBox 24x24
// consistente, currentColor para herdar do contexto.
...
const ICON_PATHS: Record<IconName, React.ReactNode> = {
  ...
  cube: (
    <>
      <path d="M21 16.5c0 .38-.21.71-.53.88l-7.9 4.44a1.97 1.97 0 0 1-1.96 0l-7.9-4.44A1 1 0 0 1 3 16.5v-9a1 1 0 0 1 .47-.84l7.9-4.43a1.99 1.99 0 0 1 1.96 0l7.9 4.43a1 1 0 0 1 .53.84v9z" />
